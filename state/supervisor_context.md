...
- latest run id: `20260421_084851_bf16_gemm_v1_96196d1`
- latest runtime: `24.634880 ms`
...
- active loop: `round 95/100` with `6` rounds remaining
...
- latest observed progress: `2026-04-21T08:48:58-07:00` via `state/graph_state.json`
- idle minutes: `0.0`
- watchdog status: `healthy`
