...
- schema version: `2`
- source run id: `20260421_194414_bf16_gemm_v1_ac1299d7`
- source run dir: `runs/20260421_194414_bf16_gemm_v1_ac1299d7`
- status: `available`
- analysis path: `runs/20260421_194414_bf16_gemm_v1_ac1299d7/ncu_analysis.json`
- raw csv path: `runs/20260421_194414_bf16_gemm_v1_ac1299d7/ncu_metrics.csv`
- raw rep path: `runs/20260421_194414_bf16_gemm_v1_ac1299d7/ncu_profile.ncu-rep`
- imported raw csv path: `runs/20260421_194414_bf16_gemm_v1_ac1299d7/ncu_import_raw.csv`
- legacy import-raw alias path: `runs/20260421_194414_bf16_gemm_v1_ac1299d7/ncu_details.csv`
- details page csv path: `runs/20260421_194414_bf16_gemm_v1_ac1299d7/ncu_details_page.csv`
- source page csv path: `runs/20260421_194414_bf16_gemm_v1_ac1299d7/ncu_source.csv`
...
- `smsp__warp_issue_stalled_barrier_per_warp_active.pct`: `8.13`
- `smsp__warp_issue_stalled_long_scoreboard_per_warp_active.pct`: `5.21`
...
- `barrier`: `8.13` | barrier stalls are consuming 8.13% of active warp issue slots.
- `long_scoreboard`: `5.21` | long scoreboard stalls are consuming 5.21% of active warp issue slots.
...
- stall `long_scoreboard`: current `5.21` vs previous `3.33` | delta `1.88` | trend `regressed`
- stall `barrier`: current `8.13` vs previous `7.86` | delta `0.27000000000000046` | trend `regressed`
- stall `mio_throttle`: current `4.0` vs previous `4.14` | delta `-0.13999999999999968` | trend `improved`
- stall `short_scoreboard`: current `2.42` vs previous `2.55` | delta `-0.1299999999999999` | trend `improved`
...
- hotspot delta: `regressed` `GPU Speed Of Light Throughput` | `DRAM Throughput` | delta `-0.009999999999999787` | trend `regressed`
...
- guardrail: `smsp__warp_issue_stalled_barrier_per_warp_active.pct` `non_increasing` from `8.13` | barrier stalls are consuming 8.13% of active warp issue slots.
- guardrail: `smsp__warp_issue_stalled_long_scoreboard_per_warp_active.pct` `non_increasing` from `5.21` | long scoreboard stalls are consuming 5.21% of active warp issue slots.
