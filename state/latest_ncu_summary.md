...
- source run id: `20260421_074828_bf16_gemm_v1_f07f873`
- source run dir: `runs/20260421_074828_bf16_gemm_v1_f07f873`
- status: `available`
- kernel name: `None`
- block size: `None`
- grid size: `None`
...
- raw csv path: `runs/20260421_074828_bf16_gemm_v1_f07f873/ncu_metrics.csv`
- raw rep path: `runs/20260421_074828_bf16_gemm_v1_f07f873/ncu_profile.ncu-rep`
- raw detailed csv path: `runs/20260421_074828_bf16_gemm_v1_f07f873/ncu_details.csv`
...
- `smsp__warp_issue_stalled_barrier_per_warp_active.pct`: `5.42`
