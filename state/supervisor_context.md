...
- latest run id: `20260421_084349_bf16_gemm_v1_7353805`
- latest runtime: `24.405503 ms`
...
- active loop: `round 65/100` with `36` rounds remaining
...
- latest observed progress: `2026-04-21T08:43:56-07:00` via `state/graph_state.json`
- idle minutes: `0.0`
- watchdog status: `healthy`
