...
- latest run id: `20260421_084620_bf16_gemm_v1_1369f89`
- latest runtime: `24.624128 ms`
...
- active loop: `round 80/100` with `21` rounds remaining
...
- latest observed progress: `2026-04-21T08:46:26-07:00` via `state/graph_state.json`
- idle minutes: `0.0`
- watchdog status: `healthy`
