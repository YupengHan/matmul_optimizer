...
- latest run id: `20260421_084701_bf16_gemm_v1_b5784f4`
- latest runtime: `30.694863 ms`
...
- active loop: `round 84/100` with `17` rounds remaining
- auto-use recommended: `yes`
- auto-select frontier: `no`
- context compression cadence: every `5` completed rounds
- public display refresh cadence: every `5` completed rounds
- last context compression checkpoint: after `80` completed rounds
- next context compression checkpoint: after `85` completed rounds
- last display refresh checkpoint: after `80` completed rounds
- next display refresh checkpoint: after `85` completed rounds
...
- latest observed progress: `2026-04-21T08:47:08-07:00` via `state/graph_state.json`
- idle minutes: `0.0`
- watchdog status: `healthy`
