...
- stall `barrier` | delta `-0.08000000000000007` | trend `improved`
- stall `mio_throttle` | delta `-0.08000000000000007` | trend `improved`
- stall `long_scoreboard` | delta `0.010000000000000009` | trend `regressed`
