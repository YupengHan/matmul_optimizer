...
def build_diagnosis_records(
    ...
    for index, record in enumerate(diagnosis_commits):
        ...
        diagnosis_payload = json.loads(diagnosis_text) if diagnosis_text else {}
        ...
        diagnosis_records.append(
            {
                ...
                "directions": diagnosis_payload.get("directions", []),
                ...
                "selected_direction_name": selected_direction_name,
...
def build_attempt_records(
    ...
    for record in node_c_commits:
        ...
        linked_direction = next(
            (
                direction
                for direction in (linked_diagnosis.get("directions") or [])
