...
- source run id: `20260420_224147_bf16_gemm_v1_df5bac2`
- source run dir: `runs/20260420_224147_bf16_gemm_v1_df5bac2`
- status: `available`
- kernel name: `None`
- block size: `None`
- grid size: `None`
...
- raw csv path: `runs/20260420_224147_bf16_gemm_v1_df5bac2/ncu_metrics.csv`
- raw rep path: `runs/20260420_224147_bf16_gemm_v1_df5bac2/ncu_profile.ncu-rep`
- raw detailed csv path: `runs/20260420_224147_bf16_gemm_v1_df5bac2/ncu_details.csv`
...
- `lts__throughput.avg.pct_of_peak_sustained_elapsed`: `30.32`
