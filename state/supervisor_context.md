...
- latest run id: `20260421_083902_bf16_gemm_v1_ba5aa59`
- latest runtime: `24.426496 ms`
...
- active loop: `round 46/100` with `55` rounds remaining
...
- latest observed progress: `2026-04-21T08:39:08-07:00` via `state/graph_state.json`
- idle minutes: `0.0`
- watchdog status: `healthy`
