...
- latest run id: `20260421_084914_bf16_gemm_v1_c90a7df`
- latest runtime: `24.645008 ms`
...
- active loop: `round 97/100` with `4` rounds remaining
...
- latest observed progress: `2026-04-21T08:49:21-07:00` via `state/graph_state.json`
- idle minutes: `0.0`
- watchdog status: `healthy`
