...
- candidate id: `auto_diagnosis_round_088:dir_01`
- base run id: `20260421_084743_bf16_gemm_v1_980ec98`
...
- source diagnosis id: `auto_diagnosis_round_088`
- round loop: `round 88/100`
- hypothesis: `The latest measured run landed at 24.639488 ms, still +0.475216 ms away from the accepted 24.164272 ms anchor. The fastest way to keep the loop grounded is to replay the exact accepted PTX surface before reopening another branch.`
