...
- schema version: `2`
- source run id: `20260421_172601_bf16_gemm_v1_117cd3e7`
- source run dir: `runs/20260421_172601_bf16_gemm_v1_117cd3e7`
- status: `available`
- analysis path: `runs/20260421_172601_bf16_gemm_v1_117cd3e7/ncu_analysis.json`
- raw csv path: `runs/20260421_172601_bf16_gemm_v1_117cd3e7/ncu_metrics.csv`
- raw rep path: `runs/20260421_172601_bf16_gemm_v1_117cd3e7/ncu_profile.ncu-rep`
- imported raw csv path: `runs/20260421_172601_bf16_gemm_v1_117cd3e7/ncu_import_raw.csv`
- legacy import-raw alias path: `runs/20260421_172601_bf16_gemm_v1_117cd3e7/ncu_details.csv`
- details page csv path: `runs/20260421_172601_bf16_gemm_v1_117cd3e7/ncu_details_page.csv`
- source page csv path: `runs/20260421_172601_bf16_gemm_v1_117cd3e7/ncu_source.csv`
...
- `lts__throughput.avg.pct_of_peak_sustained_elapsed`: `30.03`
- `sm__warps_active.avg.pct_of_peak_sustained_active`: `16.59`
- `smsp__warp_issue_stalled_barrier_per_warp_active.pct`: `6.39`
...
- `barrier`: `6.39` | barrier stalls are consuming 6.39% of active warp issue slots.
...
- `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `L2 Cache Throughput` = `30.21` | GPU Speed Of Light Throughput is carrying metric L2 Cache Throughput.
...
- stall `mio_throttle`: current `3.98` vs previous `15.39` | delta `-11.41` | trend `improved`
- stall `barrier`: current `6.39` vs previous `9.8` | delta `-3.410000000000001` | trend `improved`
- stall `short_scoreboard`: current `1.86` vs previous `3.19` | delta `-1.3299999999999998` | trend `improved`
- stall `long_scoreboard`: current `5.53` vs previous `4.64` | delta `0.8900000000000006` | trend `regressed`
...
- hotspot delta: `regressed` `GPU Speed Of Light Throughput` | `DRAM Throughput` | delta `-0.41000000000000014` | trend `regressed`
- hotspot delta: `regressed` `Occupancy` | `Achieved Occupancy` | delta `-0.020000000000003126` | trend `regressed`
...
- finding: Tensor activity (48.36%) is low relative to available memory bandwidth, and active warps (16.59%) are not hiding latency. (evidence: metric::sm__pipe_tensor_cycles_active.avg.pct_of_peak_sustained_active)
...
- target hotspot: `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `L2 Cache Throughput` = `30.21` | GPU Speed Of Light Throughput is carrying metric L2 Cache Throughput.
...
- guardrail: `smsp__warp_issue_stalled_barrier_per_warp_active.pct` `non_increasing` from `6.39` | barrier stalls are consuming 6.39% of active warp issue slots.
