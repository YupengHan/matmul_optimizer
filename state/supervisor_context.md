...
- active loop: `round 90/100` with `11` rounds remaining
...
- latest observed progress: `2026-04-21T08:48:07-07:00` via `state/latest_diagnosis.json`
- idle minutes: `0.0`
- watchdog status: `healthy`
