...
- latest run id: `20260421_084521_bf16_gemm_v1_a20af07`
- latest runtime: `24.742832 ms`
...
- active loop: `round 74/100` with `27` rounds remaining
...
- latest observed progress: `2026-04-21T08:45:27-07:00` via `state/graph_state.json`
- idle minutes: `0.0`
- watchdog status: `healthy`
