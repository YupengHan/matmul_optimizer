...
- `smsp__warp_issue_stalled_barrier_per_warp_active.pct` `non_increasing` from `6.42` | barrier stalls are consuming 6.42% of active warp issue slots.
- `smsp__warp_issue_stalled_long_scoreboard_per_warp_active.pct` `non_increasing` from `5.52` | long scoreboard stalls are consuming 5.52% of active warp issue slots.
