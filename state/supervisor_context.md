...
- latest run id: `20260421_083912_bf16_gemm_v1_280dbc5`
- latest runtime: `24.399680 ms`
...
- active loop: `round 47/100` with `54` rounds remaining
...
- latest observed progress: `2026-04-21T08:39:19-07:00` via `state/graph_state.json`
- idle minutes: `0.0`
- watchdog status: `healthy`
