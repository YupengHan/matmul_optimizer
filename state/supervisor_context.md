...
- latest run id: `20260421_084743_bf16_gemm_v1_980ec98`
- latest runtime: `24.639488 ms`
...
- active loop: `round 88/100` with `13` rounds remaining
...
- latest observed progress: `2026-04-21T08:47:49-07:00` via `state/graph_state.json`
- idle minutes: `0.0`
- watchdog status: `healthy`
