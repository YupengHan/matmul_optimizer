...
- latest run id: `20260421_084901_bf16_gemm_v1_f104aae`
- latest runtime: `24.657360 ms`
...
- active loop: `round 96/100` with `5` rounds remaining
...
- latest observed progress: `2026-04-21T08:49:07-07:00` via `state/graph_state.json`
- idle minutes: `0.0`
- watchdog status: `healthy`
