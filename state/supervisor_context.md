...
- latest run id: `20260421_084331_bf16_gemm_v1_8ad35c4`
- latest runtime: `24.392704 ms`
...
- active loop: `round 63/100` with `38` rounds remaining
...
- latest observed progress: `2026-04-21T08:43:38-07:00` via `state/graph_state.json`
- idle minutes: `0.0`
- watchdog status: `healthy`
