...
- schema version: `2`
- source run id: `20260421_153021_bf16_gemm_v1_24f31aab`
- source run dir: `runs/20260421_153021_bf16_gemm_v1_24f31aab`
- status: `available`
- analysis path: `runs/20260421_153021_bf16_gemm_v1_24f31aab/ncu_analysis.json`
- raw csv path: `runs/20260421_153021_bf16_gemm_v1_24f31aab/ncu_metrics.csv`
- raw rep path: `runs/20260421_153021_bf16_gemm_v1_24f31aab/ncu_profile.ncu-rep`
- imported raw csv path: `runs/20260421_153021_bf16_gemm_v1_24f31aab/ncu_import_raw.csv`
- legacy import-raw alias path: `runs/20260421_153021_bf16_gemm_v1_24f31aab/ncu_details.csv`
- details page csv path: `runs/20260421_153021_bf16_gemm_v1_24f31aab/ncu_details_page.csv`
- source page csv path: `runs/20260421_153021_bf16_gemm_v1_24f31aab/ncu_source.csv`
...
- `lts__throughput.avg.pct_of_peak_sustained_elapsed`: `29.96`
- `sm__warps_active.avg.pct_of_peak_sustained_active`: `16.61`
- `smsp__warp_issue_stalled_barrier_per_warp_active.pct`: `5.49`
- `smsp__warp_issue_stalled_long_scoreboard_per_warp_active.pct`: `7.21`
- `smsp__warp_issue_stalled_short_scoreboard_per_warp_active.pct`: `2.24`
- `smsp__warp_issue_stalled_mio_throttle_per_warp_active.pct`: `3.57`
...
- `long_scoreboard`: `7.21` | long scoreboard stalls are consuming 7.21% of active warp issue slots.
- `barrier`: `5.49` | barrier stalls are consuming 5.49% of active warp issue slots.
- `mio_throttle`: `3.57` | mio throttle stalls are consuming 3.57% of active warp issue slots.
...
- `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `L1/TEX Cache Throughput` = `46.6` | GPU Speed Of Light Throughput is carrying metric L1/TEX Cache Throughput.
...
- stall `long_scoreboard`: current `7.21` vs previous `7.15` | delta `0.05999999999999961` | trend `regressed`
- stall `mio_throttle`: current `3.57` vs previous `3.59` | delta `-0.020000000000000018` | trend `improved`
- stall `barrier`: current `5.49` vs previous `5.48` | delta `0.009999999999999787` | trend `regressed`
- stall `short_scoreboard`: current `2.24` vs previous `2.24` | delta `0.0` | trend `flat`
...
- finding: Tensor activity (48.33%) is low relative to available memory bandwidth, and active warps (16.61%) are not hiding latency. (evidence: metric::sm__pipe_tensor_cycles_active.avg.pct_of_peak_sustained_active)
...
- target hotspot: `section` `Launch Statistics` @ `Launch Statistics` | `Registers Per Thread` = `196.0` | Launch Statistics is carrying metric Registers Per Thread.
- target hotspot: `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `DRAM Throughput` = `12.48` | GPU Speed Of Light Throughput is carrying metric DRAM Throughput.
...
- target hotspot: `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `L2 Cache Throughput` = `30.13` | GPU Speed Of Light Throughput is carrying metric L2 Cache Throughput.
...
- guardrail: `smsp__warp_issue_stalled_long_scoreboard_per_warp_active.pct` `non_increasing` from `7.21` | long scoreboard stalls are consuming 7.21% of active warp issue slots.
- guardrail: `smsp__warp_issue_stalled_barrier_per_warp_active.pct` `non_increasing` from `5.49` | barrier stalls are consuming 5.49% of active warp issue slots.
