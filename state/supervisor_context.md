...
- active loop: `round 54/100` with `47` rounds remaining
...
- latest observed progress: `2026-04-21T08:42:07-07:00` via `state/graph_state.json`
- idle minutes: `0.0`
- watchdog status: `healthy`
