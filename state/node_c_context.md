...
- candidate id: `auto_diagnosis_round_058:dir_01`
- base run id: `20260421_084241_bf16_gemm_v1_90b9815`
...
- source diagnosis id: `auto_diagnosis_round_058`
- round loop: `round 58/100`
- hypothesis: `The latest measured run landed at 24.539136 ms, still +0.374864 ms away from the accepted 24.164272 ms anchor. The fastest way to keep the loop grounded is to replay the exact accepted PTX surface before reopening another branch.`
