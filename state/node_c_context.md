...
- latest NCU analysis: `runs/20260421_195018_bf16_gemm_v1_6dd4c8bb/ncu_analysis.json`
...
- `smsp__warp_issue_stalled_barrier_per_warp_active.pct` `non_increasing` from `8.16` | barrier stalls are consuming 8.16% of active warp issue slots.
- `smsp__warp_issue_stalled_long_scoreboard_per_warp_active.pct` `non_increasing` from `5.18` | long scoreboard stalls are consuming 5.18% of active warp issue slots.
...
- stall `short_scoreboard` | delta `-3.76` | trend `improved`
- stall `long_scoreboard` | delta `2.8` | trend `regressed`
- stall `mio_throttle` | delta `2.2` | trend `regressed`
- stall `barrier` | delta `-1.4800000000000004` | trend `improved`
