...
- candidate id: `auto_diagnosis_round_061:dir_01`
- base run id: `20260421_084309_bf16_gemm_v1_185443a`
...
- source diagnosis id: `auto_diagnosis_round_061`
- round loop: `round 61/100`
- hypothesis: `The latest run is 24.402945 ms against an accepted anchor of 24.164272 ms. Round round 60/100 should replay the bounded `non_ptx_grouped` family once from the current state so the search keeps advancing instead of restoring forever.`
