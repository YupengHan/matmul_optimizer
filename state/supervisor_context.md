...
- active loop: `round 58/100` with `43` rounds remaining
...
- latest observed progress: `2026-04-21T08:42:47-07:00` via `state/active_direction.json`
- idle minutes: `0.0`
- watchdog status: `healthy`
