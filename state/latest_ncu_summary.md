...
- schema version: `2`
- source run id: `20260421_191613_bf16_gemm_v1_9652b835`
- source run dir: `runs/20260421_191613_bf16_gemm_v1_9652b835`
- status: `available`
- analysis path: `runs/20260421_191613_bf16_gemm_v1_9652b835/ncu_analysis.json`
- raw csv path: `runs/20260421_191613_bf16_gemm_v1_9652b835/ncu_metrics.csv`
- raw rep path: `runs/20260421_191613_bf16_gemm_v1_9652b835/ncu_profile.ncu-rep`
- imported raw csv path: `runs/20260421_191613_bf16_gemm_v1_9652b835/ncu_import_raw.csv`
- legacy import-raw alias path: `runs/20260421_191613_bf16_gemm_v1_9652b835/ncu_details.csv`
- details page csv path: `runs/20260421_191613_bf16_gemm_v1_9652b835/ncu_details_page.csv`
- source page csv path: `runs/20260421_191613_bf16_gemm_v1_9652b835/ncu_source.csv`
...
- `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `L2 Cache Throughput` = `18.2` | GPU Speed Of Light Throughput is carrying metric L2 Cache Throughput.
...
- stall `short_scoreboard`: current `6.77` vs previous `2.42` | delta `4.35` | trend `regressed`
- stall `mio_throttle`: current `0.84` vs previous `4.0` | delta `-3.16` | trend `improved`
- stall `long_scoreboard`: current `2.19` vs previous `5.16` | delta `-2.97` | trend `improved`
- stall `barrier`: current `8.32` vs previous `8.14` | delta `0.17999999999999972` | trend `regressed`
...
- hotspot delta: `regressed` `GPU Speed Of Light Throughput` | `Compute (SM) Throughput` | delta `-11.579999999999998` | trend `regressed`
- hotspot delta: `improved` `GPU Speed Of Light Throughput` | `DRAM Throughput` | delta `3.3999999999999986` | trend `improved`
...
- target hotspot: `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `L2 Cache Throughput` = `18.2` | GPU Speed Of Light Throughput is carrying metric L2 Cache Throughput.
