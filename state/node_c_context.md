...
- candidate id: `auto_diagnosis_round_050:dir_01`
- base run id: `20260421_083940_bf16_gemm_v1_fa87326`
...
- source diagnosis id: `auto_diagnosis_round_050`
- round loop: `round 50/100`
- hypothesis: `The latest measured run landed at 24.745904 ms, still +0.581632 ms away from the accepted 24.164272 ms anchor. The fastest way to keep the loop grounded is to replay the exact accepted PTX surface before reopening another branch.`
