...
- schema version: `2`
- source run id: `20260421_190652_bf16_gemm_v1_88a8acfc`
- source run dir: `runs/20260421_190652_bf16_gemm_v1_88a8acfc`
- status: `available`
- analysis path: `runs/20260421_190652_bf16_gemm_v1_88a8acfc/ncu_analysis.json`
- raw csv path: `runs/20260421_190652_bf16_gemm_v1_88a8acfc/ncu_metrics.csv`
- raw rep path: `runs/20260421_190652_bf16_gemm_v1_88a8acfc/ncu_profile.ncu-rep`
- imported raw csv path: `runs/20260421_190652_bf16_gemm_v1_88a8acfc/ncu_import_raw.csv`
- legacy import-raw alias path: `runs/20260421_190652_bf16_gemm_v1_88a8acfc/ncu_details.csv`
- details page csv path: `runs/20260421_190652_bf16_gemm_v1_88a8acfc/ncu_details_page.csv`
- source page csv path: `runs/20260421_190652_bf16_gemm_v1_88a8acfc/ncu_source.csv`
...
- `dram__throughput.avg.pct_of_peak_sustained_elapsed`: `12.51`
- `lts__throughput.avg.pct_of_peak_sustained_elapsed`: `30.09`
- `sm__warps_active.avg.pct_of_peak_sustained_active`: `16.61`
- `smsp__warp_issue_stalled_barrier_per_warp_active.pct`: `8.14`
- `smsp__warp_issue_stalled_long_scoreboard_per_warp_active.pct`: `5.16`
...
- `long_scoreboard`: `5.16` | long scoreboard stalls are consuming 5.16% of active warp issue slots.
...
- `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `L2 Cache Throughput` = `29.82` | GPU Speed Of Light Throughput is carrying metric L2 Cache Throughput.
...
- `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `L1/TEX Cache Throughput` = `46.75` | GPU Speed Of Light Throughput is carrying metric L1/TEX Cache Throughput.
...
- stall `long_scoreboard`: current `5.16` vs previous `0.19` | delta `4.97` | trend `regressed`
- stall `barrier`: current `8.14` vs previous `8.96` | delta `-0.8200000000000003` | trend `improved`
- stall `short_scoreboard`: current `2.42` vs previous `1.92` | delta `0.5` | trend `regressed`
- stall `mio_throttle`: current `4.0` vs previous `4.39` | delta `-0.3899999999999997` | trend `improved`
...
- hotspot delta: `regressed` `GPU Speed Of Light Throughput` | `DRAM Throughput` | delta `-0.019999999999999574` | trend `regressed`
...
- target hotspot: `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `L2 Cache Throughput` = `29.82` | GPU Speed Of Light Throughput is carrying metric L2 Cache Throughput.
...
- guardrail: `smsp__warp_issue_stalled_long_scoreboard_per_warp_active.pct` `non_increasing` from `5.16` | long scoreboard stalls are consuming 5.16% of active warp issue slots.
