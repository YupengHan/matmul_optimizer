...
- latest run id: `20260421_083959_bf16_gemm_v1_64d7808`
- latest runtime: `30.710640 ms`
...
- active loop: `round 52/100` with `49` rounds remaining
...
- latest observed progress: `2026-04-21T08:40:06-07:00` via `state/graph_state.json`
- idle minutes: `0.0`
- watchdog status: `healthy`
