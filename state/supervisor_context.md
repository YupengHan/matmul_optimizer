...
- latest run id: `20260421_084733_bf16_gemm_v1_1bd7b32`
- latest runtime: `24.506880 ms`
...
- active loop: `round 87/100` with `14` rounds remaining
- auto-use recommended: `yes`
- auto-select frontier: `no`
- context compression cadence: every `5` completed rounds
- public display refresh cadence: every `5` completed rounds
- last context compression checkpoint: after `85` completed rounds
- next context compression checkpoint: after `90` completed rounds
- last display refresh checkpoint: after `85` completed rounds
- next display refresh checkpoint: after `90` completed rounds
...
- latest observed progress: `2026-04-21T08:47:40-07:00` via `state/graph_state.json`
- idle minutes: `0.0`
- watchdog status: `healthy`
