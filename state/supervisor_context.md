...
- active loop: `round 85/100` with `16` rounds remaining
...
- latest observed progress: `2026-04-21T08:47:17-07:00` via `state/active_direction.json`
- idle minutes: `0.0`
- watchdog status: `healthy`
