...
- candidate id: `auto_diagnosis_round_056:dir_01`
- base run id: `20260421_084219_bf16_gemm_v1_b4ac142`
...
- source diagnosis id: `auto_diagnosis_round_056`
- round loop: `round 56/100`
- hypothesis: `The latest measured run landed at 24.402352 ms, still +0.238080 ms away from the accepted 24.164272 ms anchor. The fastest way to keep the loop grounded is to replay the exact accepted PTX surface before reopening another branch.`
