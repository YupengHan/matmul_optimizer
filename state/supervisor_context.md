...
- latest run id: `20260421_084210_bf16_gemm_v1_d5dd8af`
- latest runtime: `24.429040 ms`
...
- active loop: `round 55/100` with `46` rounds remaining
...
- latest observed progress: `2026-04-21T08:42:17-07:00` via `state/graph_state.json`
- idle minutes: `0.0`
- watchdog status: `healthy`
