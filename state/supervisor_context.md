...
- active loop: `round 70/100` with `31` rounds remaining
...
- latest observed progress: `2026-04-21T08:44:46-07:00` via `state/latest_diagnosis.json`
- idle minutes: `0.0`
- watchdog status: `healthy`
