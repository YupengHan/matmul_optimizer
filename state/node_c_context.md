...
- `smsp__warp_issue_stalled_long_scoreboard_per_warp_active.pct` `non_increasing` from `6.1` | long scoreboard stalls are consuming 6.10% of active warp issue slots.
- `smsp__warp_issue_stalled_barrier_per_warp_active.pct` `non_increasing` from `5.76` | barrier stalls are consuming 5.76% of active warp issue slots.
