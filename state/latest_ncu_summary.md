...
- schema version: `2`
- source run id: `20260421_192933_bf16_gemm_v1_09758191`
- source run dir: `runs/20260421_192933_bf16_gemm_v1_09758191`
- status: `available`
- analysis path: `runs/20260421_192933_bf16_gemm_v1_09758191/ncu_analysis.json`
- raw csv path: `runs/20260421_192933_bf16_gemm_v1_09758191/ncu_metrics.csv`
- raw rep path: `runs/20260421_192933_bf16_gemm_v1_09758191/ncu_profile.ncu-rep`
- imported raw csv path: `runs/20260421_192933_bf16_gemm_v1_09758191/ncu_import_raw.csv`
- legacy import-raw alias path: `runs/20260421_192933_bf16_gemm_v1_09758191/ncu_details.csv`
- details page csv path: `runs/20260421_192933_bf16_gemm_v1_09758191/ncu_details_page.csv`
- source page csv path: `runs/20260421_192933_bf16_gemm_v1_09758191/ncu_source.csv`
...
- `lts__throughput.avg.pct_of_peak_sustained_elapsed`: `29.93`
- `sm__warps_active.avg.pct_of_peak_sustained_active`: `16.61`
- `smsp__warp_issue_stalled_barrier_per_warp_active.pct`: `8.14`
- `smsp__warp_issue_stalled_long_scoreboard_per_warp_active.pct`: `5.2`
- `smsp__warp_issue_stalled_short_scoreboard_per_warp_active.pct`: `2.42`
- `smsp__warp_issue_stalled_mio_throttle_per_warp_active.pct`: `4.01`
...
- `barrier`: `8.14` | barrier stalls are consuming 8.14% of active warp issue slots.
- `long_scoreboard`: `5.2` | long scoreboard stalls are consuming 5.20% of active warp issue slots.
- `mio_throttle`: `4.01` | mio throttle stalls are consuming 4.01% of active warp issue slots.
...
- `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `DRAM Throughput` = `12.47` | GPU Speed Of Light Throughput is carrying metric DRAM Throughput.
...
- `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `L2 Cache Throughput` = `29.96` | GPU Speed Of Light Throughput is carrying metric L2 Cache Throughput.
...
- `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `L1/TEX Cache Throughput` = `46.8` | GPU Speed Of Light Throughput is carrying metric L1/TEX Cache Throughput.
- `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `Compute (SM) Throughput` = `47.87` | GPU Speed Of Light Throughput is carrying metric Compute (SM) Throughput.

## Delta vs previous run

- baseline run id: `20260421_192654_bf16_gemm_v1_40488b6e`
- stall `long_scoreboard`: current `5.2` vs previous `0.19` | delta `5.01` | trend `regressed`
- stall `barrier`: current `8.14` vs previous `8.84` | delta `-0.6999999999999993` | trend `improved`
- stall `short_scoreboard`: current `2.42` vs previous `1.95` | delta `0.47` | trend `regressed`
- stall `mio_throttle`: current `4.01` vs previous `4.4` | delta `-0.39000000000000057` | trend `improved`
...
- finding: Tensor activity (48.37%) is low relative to available memory bandwidth, and active warps (16.61%) are not hiding latency. (evidence: metric::sm__pipe_tensor_cycles_active.avg.pct_of_peak_sustained_active)
...
- target hotspot: `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `DRAM Throughput` = `12.47` | GPU Speed Of Light Throughput is carrying metric DRAM Throughput.
...
- target hotspot: `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `L2 Cache Throughput` = `29.96` | GPU Speed Of Light Throughput is carrying metric L2 Cache Throughput.
...
- guardrail: `smsp__warp_issue_stalled_barrier_per_warp_active.pct` `non_increasing` from `8.14` | barrier stalls are consuming 8.14% of active warp issue slots.
- guardrail: `smsp__warp_issue_stalled_long_scoreboard_per_warp_active.pct` `non_increasing` from `5.2` | long scoreboard stalls are consuming 5.20% of active warp issue slots.
