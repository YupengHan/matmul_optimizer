...
- schema version: `2`
- source run id: `20260421_150200_bf16_gemm_v1_f4fa1bbe`
- source run dir: `runs/20260421_150200_bf16_gemm_v1_f4fa1bbe`
- status: `available`
- analysis path: `runs/20260421_150200_bf16_gemm_v1_f4fa1bbe/ncu_analysis.json`
- raw csv path: `runs/20260421_150200_bf16_gemm_v1_f4fa1bbe/ncu_metrics.csv`
- raw rep path: `runs/20260421_150200_bf16_gemm_v1_f4fa1bbe/ncu_profile.ncu-rep`
- imported raw csv path: `runs/20260421_150200_bf16_gemm_v1_f4fa1bbe/ncu_import_raw.csv`
- legacy import-raw alias path: `runs/20260421_150200_bf16_gemm_v1_f4fa1bbe/ncu_details.csv`
- details page csv path: `runs/20260421_150200_bf16_gemm_v1_f4fa1bbe/ncu_details_page.csv`
- source page csv path: `runs/20260421_150200_bf16_gemm_v1_f4fa1bbe/ncu_source.csv`
...
- `sm__throughput.avg.pct_of_peak_sustained_elapsed`: `47.8`
- `gpu__compute_memory_throughput.avg.pct_of_peak_sustained_elapsed`: `46.09`
- `dram__throughput.avg.pct_of_peak_sustained_elapsed`: `10.72`
- `lts__throughput.avg.pct_of_peak_sustained_elapsed`: `29.11`
- `sm__warps_active.avg.pct_of_peak_sustained_active`: `16.65`
- `smsp__warp_issue_stalled_barrier_per_warp_active.pct`: `5.92`
- `smsp__warp_issue_stalled_long_scoreboard_per_warp_active.pct`: `6.89`
- `smsp__warp_issue_stalled_short_scoreboard_per_warp_active.pct`: `2.26`
- `smsp__warp_issue_stalled_mio_throttle_per_warp_active.pct`: `3.87`
...
- `long_scoreboard`: `6.89` | long scoreboard stalls are consuming 6.89% of active warp issue slots.
- `barrier`: `5.92` | barrier stalls are consuming 5.92% of active warp issue slots.
- `mio_throttle`: `3.87` | mio throttle stalls are consuming 3.87% of active warp issue slots.
- `short_scoreboard`: `2.26` | short scoreboard stalls are consuming 2.26% of active warp issue slots.
...
- `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `Compute (SM) Throughput` = `47.8` | GPU Speed Of Light Throughput is carrying metric Compute (SM) Throughput.

## Delta vs previous run

- baseline run id: `20260421_145629_bf16_gemm_v1_5383596d`
- stall `mio_throttle`: current `3.87` vs previous `3.71` | delta `0.16000000000000014` | trend `regressed`
- stall `barrier`: current `5.92` vs previous `5.98` | delta `-0.0600000000000005` | trend `improved`
- stall `long_scoreboard`: current `6.89` vs previous `6.88` | delta `0.009999999999999787` | trend `regressed`
- stall `short_scoreboard`: current `2.26` vs previous `2.25` | delta `0.009999999999999787` | trend `regressed`
...
- finding: Tensor activity (48.40%) is low relative to available memory bandwidth, and active warps (16.65%) are not hiding latency. (evidence: metric::sm__pipe_tensor_cycles_active.avg.pct_of_peak_sustained_active)
...
- target hotspot: `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `DRAM Throughput` = `10.78` | GPU Speed Of Light Throughput is carrying metric DRAM Throughput.
...
- target hotspot: `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `L2 Cache Throughput` = `28.8` | GPU Speed Of Light Throughput is carrying metric L2 Cache Throughput.
...
- guardrail: `sm__warps_active.avg.pct_of_peak_sustained_active` `non_decreasing` from `16.65` | Latency-hiding is already weak; active warps should not regress.
- guardrail: `smsp__warp_issue_stalled_long_scoreboard_per_warp_active.pct` `non_increasing` from `6.89` | long scoreboard stalls are consuming 6.89% of active warp issue slots.
- guardrail: `smsp__warp_issue_stalled_barrier_per_warp_active.pct` `non_increasing` from `5.92` | barrier stalls are consuming 5.92% of active warp issue slots.
