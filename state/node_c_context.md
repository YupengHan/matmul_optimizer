...
- candidate id: `auto_diagnosis_round_074:dir_01`
- base run id: `20260421_084521_bf16_gemm_v1_a20af07`
...
- source diagnosis id: `auto_diagnosis_round_074`
- round loop: `round 74/100`
- hypothesis: `The latest measured run landed at 24.742832 ms, still +0.578560 ms away from the accepted 24.164272 ms anchor. The fastest way to keep the loop grounded is to replay the exact accepted PTX surface before reopening another branch.`
