...
- candidate id: `auto_diagnosis_round_072:dir_01`
- base run id: `20260421_084502_bf16_gemm_v1_a4827bc`
...
- source diagnosis id: `auto_diagnosis_round_072`
- round loop: `round 72/100`
- hypothesis: `The latest measured run landed at 24.455632 ms, still +0.291360 ms away from the accepted 24.164272 ms anchor. The fastest way to keep the loop grounded is to replay the exact accepted PTX surface before reopening another branch.`
