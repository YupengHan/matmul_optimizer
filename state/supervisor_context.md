...
- latest run id: `20260421_013042_bf16_gemm_v1_bb69e9b`
- latest runtime: `25.911183 ms`
...
- active loop: `round 30/100` with `71` rounds remaining
...
- latest observed progress: `2026-04-21T01:34:16-07:00` via `state/graph_state.json`
- idle minutes: `0.0`
- watchdog status: `healthy`
