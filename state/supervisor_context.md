...
- latest run id: `20260421_084530_bf16_gemm_v1_81595f4`
- latest runtime: `24.419360 ms`
...
- active loop: `round 75/100` with `26` rounds remaining
...
- latest observed progress: `2026-04-21T08:45:36-07:00` via `state/graph_state.json`
- idle minutes: `0.0`
- watchdog status: `healthy`
