...
- notes: `Build passed for round 64/100. Node A will measure the result next.`
...
- verdict: `regressed`
- runtime delta: `+0.033280 ms`
- TFLOP/s delta: `-0.040609 TFLOP/s`
- run dir: `runs/20260421_084340_bf16_gemm_v1_d5925ef`
- ncu rep path: `runs/20260421_084340_bf16_gemm_v1_d5925ef/ncu_profile.ncu-rep`
