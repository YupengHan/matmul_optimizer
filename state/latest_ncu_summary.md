...
- schema version: `2`
- source run id: `20260421_152228_bf16_gemm_v1_2fbb368d`
- source run dir: `runs/20260421_152228_bf16_gemm_v1_2fbb368d`
- status: `available`
- analysis path: `runs/20260421_152228_bf16_gemm_v1_2fbb368d/ncu_analysis.json`
- raw csv path: `runs/20260421_152228_bf16_gemm_v1_2fbb368d/ncu_metrics.csv`
- raw rep path: `runs/20260421_152228_bf16_gemm_v1_2fbb368d/ncu_profile.ncu-rep`
- imported raw csv path: `runs/20260421_152228_bf16_gemm_v1_2fbb368d/ncu_import_raw.csv`
- legacy import-raw alias path: `runs/20260421_152228_bf16_gemm_v1_2fbb368d/ncu_details.csv`
- details page csv path: `runs/20260421_152228_bf16_gemm_v1_2fbb368d/ncu_details_page.csv`
- source page csv path: `runs/20260421_152228_bf16_gemm_v1_2fbb368d/ncu_source.csv`
...
- `lts__throughput.avg.pct_of_peak_sustained_elapsed`: `29.82`
- `sm__warps_active.avg.pct_of_peak_sustained_active`: `16.62`
- `smsp__warp_issue_stalled_barrier_per_warp_active.pct`: `5.48`
- `smsp__warp_issue_stalled_long_scoreboard_per_warp_active.pct`: `7.15`
- `smsp__warp_issue_stalled_short_scoreboard_per_warp_active.pct`: `2.24`
- `smsp__warp_issue_stalled_mio_throttle_per_warp_active.pct`: `3.59`
...
- `long_scoreboard`: `7.15` | long scoreboard stalls are consuming 7.15% of active warp issue slots.
- `barrier`: `5.48` | barrier stalls are consuming 5.48% of active warp issue slots.
- `mio_throttle`: `3.59` | mio throttle stalls are consuming 3.59% of active warp issue slots.
...
- `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `L2 Cache Throughput` = `29.78` | GPU Speed Of Light Throughput is carrying metric L2 Cache Throughput.
...
- stall `long_scoreboard`: current `7.15` vs previous `7.33` | delta `-0.17999999999999972` | trend `improved`
- stall `mio_throttle`: current `3.59` vs previous `3.75` | delta `-0.16000000000000014` | trend `improved`
- stall `barrier`: current `5.48` vs previous `5.33` | delta `0.15000000000000036` | trend `regressed`
- stall `short_scoreboard`: current `2.24` vs previous `2.17` | delta `0.07000000000000028` | trend `regressed`
...
- hotspot delta: `improved` `Occupancy` | `Achieved Occupancy` | delta `0.030000000000001137` | trend `improved`
...
- finding: Tensor activity (48.38%) is low relative to available memory bandwidth, and active warps (16.62%) are not hiding latency. (evidence: metric::sm__pipe_tensor_cycles_active.avg.pct_of_peak_sustained_active)
...
- target hotspot: `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `L2 Cache Throughput` = `29.78` | GPU Speed Of Light Throughput is carrying metric L2 Cache Throughput.
...
- guardrail: `smsp__warp_issue_stalled_long_scoreboard_per_warp_active.pct` `non_increasing` from `7.15` | long scoreboard stalls are consuming 7.15% of active warp issue slots.
- guardrail: `smsp__warp_issue_stalled_barrier_per_warp_active.pct` `non_increasing` from `5.48` | barrier stalls are consuming 5.48% of active warp issue slots.
