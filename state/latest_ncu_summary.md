...
- source run id: `20260421_084421_bf16_gemm_v1_098aaeb`
- source run dir: `runs/20260421_084421_bf16_gemm_v1_098aaeb`
- status: `available`
- kernel name: `None`
- block size: `None`
- grid size: `None`
...
- raw csv path: `runs/20260421_084421_bf16_gemm_v1_098aaeb/ncu_metrics.csv`
- raw rep path: `runs/20260421_084421_bf16_gemm_v1_098aaeb/ncu_profile.ncu-rep`
- raw detailed csv path: `runs/20260421_084421_bf16_gemm_v1_098aaeb/ncu_details.csv`
...
- `lts__throughput.avg.pct_of_peak_sustained_elapsed`: `18.20`
