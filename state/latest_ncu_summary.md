...
- schema version: `2`
- source run id: `20260421_185710_bf16_gemm_v1_823cbff4`
- source run dir: `runs/20260421_185710_bf16_gemm_v1_823cbff4`
- status: `available`
- analysis path: `runs/20260421_185710_bf16_gemm_v1_823cbff4/ncu_analysis.json`
- raw csv path: `runs/20260421_185710_bf16_gemm_v1_823cbff4/ncu_metrics.csv`
- raw rep path: `runs/20260421_185710_bf16_gemm_v1_823cbff4/ncu_profile.ncu-rep`
- imported raw csv path: `runs/20260421_185710_bf16_gemm_v1_823cbff4/ncu_import_raw.csv`
- legacy import-raw alias path: `runs/20260421_185710_bf16_gemm_v1_823cbff4/ncu_details.csv`
- details page csv path: `runs/20260421_185710_bf16_gemm_v1_823cbff4/ncu_details_page.csv`
- source page csv path: `runs/20260421_185710_bf16_gemm_v1_823cbff4/ncu_source.csv`
...
- `lts__throughput.avg.pct_of_peak_sustained_elapsed`: `30.11`
- `sm__warps_active.avg.pct_of_peak_sustained_active`: `16.58`
- `smsp__warp_issue_stalled_barrier_per_warp_active.pct`: `6.42`
- `smsp__warp_issue_stalled_long_scoreboard_per_warp_active.pct`: `5.52`
- `smsp__warp_issue_stalled_short_scoreboard_per_warp_active.pct`: `1.87`
...
- `barrier`: `6.42` | barrier stalls are consuming 6.42% of active warp issue slots.
- `long_scoreboard`: `5.52` | long scoreboard stalls are consuming 5.52% of active warp issue slots.
- `mio_throttle`: `3.99` | mio throttle stalls are consuming 3.99% of active warp issue slots.
- `short_scoreboard`: `1.87` | short scoreboard stalls are consuming 1.87% of active warp issue slots.
...
- `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `L2 Cache Throughput` = `30.01` | GPU Speed Of Light Throughput is carrying metric L2 Cache Throughput.
...
- stall `barrier`: current `6.42` vs previous `5.76` | delta `0.6600000000000001` | trend `regressed`
- stall `long_scoreboard`: current `5.52` vs previous `6.1` | delta `-0.5800000000000001` | trend `improved`
- stall `mio_throttle`: current `3.99` vs previous `3.81` | delta `0.18000000000000016` | trend `regressed`
- stall `short_scoreboard`: current `1.87` vs previous `1.83` | delta `0.040000000000000036` | trend `regressed`
...
- target hotspot: `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `L2 Cache Throughput` = `30.01` | GPU Speed Of Light Throughput is carrying metric L2 Cache Throughput.
...
- guardrail: `smsp__warp_issue_stalled_barrier_per_warp_active.pct` `non_increasing` from `6.42` | barrier stalls are consuming 6.42% of active warp issue slots.
- guardrail: `smsp__warp_issue_stalled_long_scoreboard_per_warp_active.pct` `non_increasing` from `5.52` | long scoreboard stalls are consuming 5.52% of active warp issue slots.
