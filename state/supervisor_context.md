...
- latest run id: `20260421_084810_bf16_gemm_v1_4cd499c`
- latest runtime: `24.619967 ms`
...
- active loop: `round 91/100` with `10` rounds remaining
- auto-use recommended: `yes`
- auto-select frontier: `no`
- context compression cadence: every `5` completed rounds
- public display refresh cadence: every `5` completed rounds
- last context compression checkpoint: after `90` completed rounds
- next context compression checkpoint: after `95` completed rounds
- last display refresh checkpoint: after `90` completed rounds
- next display refresh checkpoint: after `95` completed rounds
...
- latest observed progress: `2026-04-21T08:48:16-07:00` via `state/graph_state.json`
- idle minutes: `0.0`
- watchdog status: `healthy`
