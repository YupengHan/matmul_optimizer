...
- candidate id: `auto_diagnosis_round_096:dir_01`
- base run id: `20260421_084901_bf16_gemm_v1_f104aae`
...
- source diagnosis id: `auto_diagnosis_round_096`
- round loop: `round 96/100`
- hypothesis: `The latest measured run landed at 24.657360 ms, still +0.493088 ms away from the accepted 24.164272 ms anchor. The fastest way to keep the loop grounded is to replay the exact accepted PTX surface before reopening another branch.`
