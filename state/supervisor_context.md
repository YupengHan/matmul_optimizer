...
- latest run id: `20260421_084833_bf16_gemm_v1_bcd88dd`
- latest runtime: `24.649728 ms`
...
- active loop: `round 93/100` with `8` rounds remaining
...
- latest observed progress: `2026-04-21T08:48:39-07:00` via `state/graph_state.json`
- idle minutes: `0.0`
- watchdog status: `healthy`
