...
- latest run id: `20260421_083853_bf16_gemm_v1_4f123f5`
- latest runtime: `24.411073 ms`
...
- active loop: `round 45/100` with `56` rounds remaining
...
- latest observed progress: `2026-04-21T08:38:59-07:00` via `state/graph_state.json`
- idle minutes: `0.0`
- watchdog status: `healthy`
