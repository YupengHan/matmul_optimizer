...
- candidate id: `auto_diagnosis_round_090:dir_01`
- base run id: `20260421_084801_bf16_gemm_v1_0091940`
...
- source diagnosis id: `auto_diagnosis_round_090`
- round loop: `round 90/100`
- hypothesis: `The latest measured run landed at 24.747520 ms, still +0.583248 ms away from the accepted 24.164272 ms anchor. The fastest way to keep the loop grounded is to replay the exact accepted PTX surface before reopening another branch.`
