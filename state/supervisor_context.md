...
- latest run id: `20260421_084250_bf16_gemm_v1_28f4429`
- latest runtime: `24.388000 ms`
...
- active loop: `round 59/100` with `42` rounds remaining
...
- latest observed progress: `2026-04-21T08:42:56-07:00` via `state/graph_state.json`
- idle minutes: `0.0`
- watchdog status: `healthy`
