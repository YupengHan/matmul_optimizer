...
- candidate id: `auto_diagnosis_round_075:dir_01`
- base run id: `20260421_084530_bf16_gemm_v1_81595f4`
...
- source diagnosis id: `auto_diagnosis_round_075`
- round loop: `round 75/100`
- hypothesis: `The latest run is 24.419360 ms against an accepted anchor of 24.164272 ms. Round round 74/100 should replay the bounded `pivot_256x128` family once from the current state so the search keeps advancing instead of restoring forever.`
