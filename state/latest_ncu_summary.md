...
- source run id: `20260421_083834_bf16_gemm_v1_ded7933`
- source run dir: `runs/20260421_083834_bf16_gemm_v1_ded7933`
- status: `available`
- kernel name: `None`
- block size: `None`
- grid size: `None`
...
- raw csv path: `runs/20260421_083834_bf16_gemm_v1_ded7933/ncu_metrics.csv`
- raw rep path: `runs/20260421_083834_bf16_gemm_v1_ded7933/ncu_profile.ncu-rep`
- raw detailed csv path: `runs/20260421_083834_bf16_gemm_v1_ded7933/ncu_details.csv`
...
- `lts__throughput.avg.pct_of_peak_sustained_elapsed`: `29.98`
