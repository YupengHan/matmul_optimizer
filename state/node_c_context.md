...
- candidate id: `auto_diagnosis_round_069:dir_01`
- base run id: `20260421_084431_bf16_gemm_v1_e62d09e`
...
- source diagnosis id: `auto_diagnosis_round_069`
- round loop: `round 69/100`
- hypothesis: `The latest run is 24.438895 ms against an accepted anchor of 24.164272 ms. Round round 68/100 should replay the bounded `non_ptx_grouped` family once from the current state so the search keeps advancing instead of restoring forever.`
