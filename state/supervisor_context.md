...
- latest run id: `20260421_084259_bf16_gemm_v1_9c6355a`
- latest runtime: `30.429696 ms`
...
- active loop: `round 60/100` with `41` rounds remaining
- auto-use recommended: `yes`
- auto-select frontier: `no`
- context compression cadence: every `5` completed rounds
- public display refresh cadence: every `5` completed rounds
- last context compression checkpoint: after `55` completed rounds
- next context compression checkpoint: after `60` completed rounds
- last display refresh checkpoint: after `55` completed rounds
- next display refresh checkpoint: after `60` completed rounds
...
- latest observed progress: `2026-04-21T08:43:06-07:00` via `state/graph_state.json`
- idle minutes: `0.0`
- watchdog status: `healthy`
