...
- schema version: `2`
- source run id: `20260421_155533_bf16_gemm_v1_83acaae4`
- source run dir: `runs/20260421_155533_bf16_gemm_v1_83acaae4`
- status: `available`
- analysis path: `runs/20260421_155533_bf16_gemm_v1_83acaae4/ncu_analysis.json`
- raw csv path: `runs/20260421_155533_bf16_gemm_v1_83acaae4/ncu_metrics.csv`
- raw rep path: `runs/20260421_155533_bf16_gemm_v1_83acaae4/ncu_profile.ncu-rep`
- imported raw csv path: `runs/20260421_155533_bf16_gemm_v1_83acaae4/ncu_import_raw.csv`
- legacy import-raw alias path: `runs/20260421_155533_bf16_gemm_v1_83acaae4/ncu_details.csv`
- details page csv path: `runs/20260421_155533_bf16_gemm_v1_83acaae4/ncu_details_page.csv`
- source page csv path: `runs/20260421_155533_bf16_gemm_v1_83acaae4/ncu_source.csv`
...
- `sm__pipe_tensor_cycles_active.avg.pct_of_peak_sustained_active`: `46.83`
- `sm__throughput.avg.pct_of_peak_sustained_elapsed`: `46.73`
- `gpu__compute_memory_throughput.avg.pct_of_peak_sustained_elapsed`: `47.43`
- `dram__throughput.avg.pct_of_peak_sustained_elapsed`: `21.53`
- `lts__throughput.avg.pct_of_peak_sustained_elapsed`: `31.14`
- `sm__warps_active.avg.pct_of_peak_sustained_active`: `24.72`
- `smsp__warp_issue_stalled_barrier_per_warp_active.pct`: `11.31`
- `smsp__warp_issue_stalled_long_scoreboard_per_warp_active.pct`: `1.93`
- `smsp__warp_issue_stalled_short_scoreboard_per_warp_active.pct`: `4.62`
- `smsp__warp_issue_stalled_mio_throttle_per_warp_active.pct`: `2.06`
...
- `barrier`: `11.31` | barrier stalls are consuming 11.31% of active warp issue slots.
- `short_scoreboard`: `4.62` | short scoreboard stalls are consuming 4.62% of active warp issue slots.
- `mio_throttle`: `2.06` | mio throttle stalls are consuming 2.06% of active warp issue slots.
- `long_scoreboard`: `1.93` | long scoreboard stalls are consuming 1.93% of active warp issue slots.
...
- `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `Memory Throughput` = `47.4` | GPU Speed Of Light Throughput is carrying metric Memory Throughput.
- `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `L1/TEX Cache Throughput` = `47.48` | GPU Speed Of Light Throughput is carrying metric L1/TEX Cache Throughput.

## Delta vs previous run

- baseline run id: `20260421_155210_bf16_gemm_v1_9cac32cb`
- stall `barrier`: current `11.31` vs previous `5.61` | delta `5.7` | trend `regressed`
- stall `long_scoreboard`: current `1.93` vs previous `7.09` | delta `-5.16` | trend `improved`
- stall `short_scoreboard`: current `4.62` vs previous `2.09` | delta `2.5300000000000002` | trend `regressed`
- stall `mio_throttle`: current `2.06` vs previous `3.78` | delta `-1.7199999999999998` | trend `improved`
...
- hotspot delta: `regressed` `GPU Speed Of Light Throughput` | `Compute (SM) Throughput` | delta `-1.1000000000000014` | trend `regressed`
...
- finding: Tensor activity (46.83%) is low relative to available memory bandwidth, and active warps (24.72%) are not hiding latency. (evidence: metric::sm__pipe_tensor_cycles_active.avg.pct_of_peak_sustained_active)
...
- target hotspot: `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `DRAM Throughput` = `20.45` | GPU Speed Of Light Throughput is carrying metric DRAM Throughput.
- target hotspot: `section` `Occupancy` @ `Occupancy` | `Achieved Occupancy` = `24.71` | Occupancy is carrying metric Achieved Occupancy.
- target hotspot: `section` `Occupancy` @ `Occupancy` | `Theoretical Occupancy` = `25.0` | Occupancy is carrying metric Theoretical Occupancy.
- target hotspot: `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `L2 Cache Throughput` = `31.15` | GPU Speed Of Light Throughput is carrying metric L2 Cache Throughput.
- target hotspot: `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `Compute (SM) Throughput` = `46.73` | GPU Speed Of Light Throughput is carrying metric Compute (SM) Throughput.
- guardrail: `sm__pipe_tensor_cycles_active.avg.pct_of_peak_sustained_active` `non_decreasing` from `46.83` | Tensor activity is part of the active bottleneck picture and should not drop after the next code edit.
...
- guardrail: `smsp__warp_issue_stalled_barrier_per_warp_active.pct` `non_increasing` from `11.31` | barrier stalls are consuming 11.31% of active warp issue slots.
- guardrail: `smsp__warp_issue_stalled_short_scoreboard_per_warp_active.pct` `non_increasing` from `4.62` | short scoreboard stalls are consuming 4.62% of active warp issue slots.
