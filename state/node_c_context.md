...
- candidate id: `auto_diagnosis_round_064:dir_01`
- base run id: `20260421_084340_bf16_gemm_v1_d5925ef`
...
- source diagnosis id: `auto_diagnosis_round_064`
- round loop: `round 64/100`
- hypothesis: `The latest measured run landed at 24.425984 ms, still +0.261712 ms away from the accepted 24.164272 ms anchor. The fastest way to keep the loop grounded is to replay the exact accepted PTX surface before reopening another branch.`
