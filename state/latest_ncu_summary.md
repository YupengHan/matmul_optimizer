...
- schema version: `2`
- source run id: `20260421_150626_bf16_gemm_v1_6cc462c4`
- source run dir: `runs/20260421_150626_bf16_gemm_v1_6cc462c4`
- status: `available`
- analysis path: `runs/20260421_150626_bf16_gemm_v1_6cc462c4/ncu_analysis.json`
- raw csv path: `runs/20260421_150626_bf16_gemm_v1_6cc462c4/ncu_metrics.csv`
- raw rep path: `runs/20260421_150626_bf16_gemm_v1_6cc462c4/ncu_profile.ncu-rep`
- imported raw csv path: `runs/20260421_150626_bf16_gemm_v1_6cc462c4/ncu_import_raw.csv`
- legacy import-raw alias path: `runs/20260421_150626_bf16_gemm_v1_6cc462c4/ncu_details.csv`
- details page csv path: `runs/20260421_150626_bf16_gemm_v1_6cc462c4/ncu_details_page.csv`
- source page csv path: `runs/20260421_150626_bf16_gemm_v1_6cc462c4/ncu_source.csv`
...
- `lts__throughput.avg.pct_of_peak_sustained_elapsed`: `30.12`
- `sm__warps_active.avg.pct_of_peak_sustained_active`: `16.62`
- `smsp__warp_issue_stalled_barrier_per_warp_active.pct`: `5.46`
- `smsp__warp_issue_stalled_long_scoreboard_per_warp_active.pct`: `7.24`
- `smsp__warp_issue_stalled_short_scoreboard_per_warp_active.pct`: `2.16`
- `smsp__warp_issue_stalled_mio_throttle_per_warp_active.pct`: `3.62`
...
- `long_scoreboard`: `7.24` | long scoreboard stalls are consuming 7.24% of active warp issue slots.
- `barrier`: `5.46` | barrier stalls are consuming 5.46% of active warp issue slots.
- `mio_throttle`: `3.62` | mio throttle stalls are consuming 3.62% of active warp issue slots.
...
- `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `L2 Cache Throughput` = `30.1` | GPU Speed Of Light Throughput is carrying metric L2 Cache Throughput.
...
- stall `barrier`: current `5.46` vs previous `5.92` | delta `-0.45999999999999996` | trend `improved`
- stall `long_scoreboard`: current `7.24` vs previous `6.89` | delta `0.35000000000000053` | trend `regressed`
- stall `mio_throttle`: current `3.62` vs previous `3.87` | delta `-0.25` | trend `improved`
- stall `short_scoreboard`: current `2.16` vs previous `2.26` | delta `-0.09999999999999964` | trend `improved`
...
- hotspot delta: `improved` `GPU Speed Of Light Throughput` | `Compute (SM) Throughput` | delta `0.04000000000000625` | trend `improved`
...
- finding: Tensor activity (48.37%) is low relative to available memory bandwidth, and active warps (16.62%) are not hiding latency. (evidence: metric::sm__pipe_tensor_cycles_active.avg.pct_of_peak_sustained_active)
...
- target hotspot: `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `L2 Cache Throughput` = `30.1` | GPU Speed Of Light Throughput is carrying metric L2 Cache Throughput.
...
- guardrail: `smsp__warp_issue_stalled_long_scoreboard_per_warp_active.pct` `non_increasing` from `7.24` | long scoreboard stalls are consuming 7.24% of active warp issue slots.
- guardrail: `smsp__warp_issue_stalled_barrier_per_warp_active.pct` `non_increasing` from `5.46` | barrier stalls are consuming 5.46% of active warp issue slots.
