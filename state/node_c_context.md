...
- candidate id: `auto_diagnosis_round_087:dir_01`
- base run id: `20260421_084733_bf16_gemm_v1_1bd7b32`
...
- source diagnosis id: `auto_diagnosis_round_087`
- round loop: `round 87/100`
- hypothesis: `The latest run is 24.506880 ms against an accepted anchor of 24.164272 ms. Round round 86/100 should replay the bounded `control_path` family once from the current state so the search keeps advancing instead of restoring forever.`
