        ...
        - `runs/20260421_124420_bf16_gemm_v1_fc400df/ncu_analysis.md`
        - `runs/20260421_124420_bf16_gemm_v1_fc400df/ncu_analysis.json`
        - `docs/heuristics.md`
        - `state/progress.md`
        - `state/current_focus.md`
        - `state/human_review.md`
        - `src/kernels/bf16_gemm_v1.cu`
        - `runs/20260421_124420_bf16_gemm_v1_fc400df/summary.json`
        - `runs/20260421_124420_bf16_gemm_v1_fc400df/ncu_details_page.csv`
        - `runs/20260421_124420_bf16_gemm_v1_fc400df/ncu_source.csv`
        - `runs/20260421_124420_bf16_gemm_v1_fc400df/ncu_import_raw.csv`
        - `runs/20260421_124420_bf16_gemm_v1_fc400df/ncu_details.csv`
        - `runs/20260421_124420_bf16_gemm_v1_fc400df/ncu_metrics.csv`
        - `runs/20260421_124420_bf16_gemm_v1_fc400df/ncu_profile.ncu-rep`
...
- `state/autotune_round18_main_tiles.md`
        ...
        - rounds remaining after this one: `89`
