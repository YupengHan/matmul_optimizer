...
- schema version: `2`
- source run id: `20260421_192654_bf16_gemm_v1_40488b6e`
- source run dir: `runs/20260421_192654_bf16_gemm_v1_40488b6e`
- status: `available`
- analysis path: `runs/20260421_192654_bf16_gemm_v1_40488b6e/ncu_analysis.json`
- raw csv path: `runs/20260421_192654_bf16_gemm_v1_40488b6e/ncu_metrics.csv`
- raw rep path: `runs/20260421_192654_bf16_gemm_v1_40488b6e/ncu_profile.ncu-rep`
- imported raw csv path: `runs/20260421_192654_bf16_gemm_v1_40488b6e/ncu_import_raw.csv`
- legacy import-raw alias path: `runs/20260421_192654_bf16_gemm_v1_40488b6e/ncu_details.csv`
- details page csv path: `runs/20260421_192654_bf16_gemm_v1_40488b6e/ncu_details_page.csv`
- source page csv path: `runs/20260421_192654_bf16_gemm_v1_40488b6e/ncu_source.csv`
...
- `sm__pipe_tensor_cycles_active.avg.pct_of_peak_sustained_active`: `48.46`
- `sm__throughput.avg.pct_of_peak_sustained_elapsed`: `47.92`
- `gpu__compute_memory_throughput.avg.pct_of_peak_sustained_elapsed`: `46.27`
...
- `smsp__warp_issue_stalled_barrier_per_warp_active.pct`: `8.84`
- `smsp__warp_issue_stalled_long_scoreboard_per_warp_active.pct`: `0.19`
- `smsp__warp_issue_stalled_short_scoreboard_per_warp_active.pct`: `1.95`
- `smsp__warp_issue_stalled_mio_throttle_per_warp_active.pct`: `4.4`
...
- `barrier`: `8.84` | barrier stalls are consuming 8.84% of active warp issue slots.
- `mio_throttle`: `4.4` | mio throttle stalls are consuming 4.40% of active warp issue slots.
- `short_scoreboard`: `1.95` | short scoreboard stalls are consuming 1.95% of active warp issue slots.
...
- `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `DRAM Throughput` = `12.56` | GPU Speed Of Light Throughput is carrying metric DRAM Throughput.
...
- `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `L2 Cache Throughput` = `29.62` | GPU Speed Of Light Throughput is carrying metric L2 Cache Throughput.
...
- `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `L1/TEX Cache Throughput` = `46.83` | GPU Speed Of Light Throughput is carrying metric L1/TEX Cache Throughput.
- `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `Compute (SM) Throughput` = `47.92` | GPU Speed Of Light Throughput is carrying metric Compute (SM) Throughput.

## Delta vs previous run

- baseline run id: `20260421_192024_bf16_gemm_v1_8fd88cb4`
- stall `long_scoreboard`: current `0.19` vs previous `5.17` | delta `-4.9799999999999995` | trend `improved`
- stall `barrier`: current `8.84` vs previous `8.2` | delta `0.6400000000000006` | trend `regressed`
- stall `short_scoreboard`: current `1.95` vs previous `2.41` | delta `-0.4600000000000002` | trend `improved`
- stall `mio_throttle`: current `4.4` vs previous `4.0` | delta `0.40000000000000036` | trend `regressed`
...
- hotspot delta: `improved` `GPU Speed Of Light Throughput` | `L1/TEX Cache Throughput` | delta `0.01999999999999602` | trend `improved`
...
- finding: Tensor activity (48.46%) is low relative to available memory bandwidth, and active warps (16.61%) are not hiding latency. (evidence: metric::sm__pipe_tensor_cycles_active.avg.pct_of_peak_sustained_active)
...
- target hotspot: `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `DRAM Throughput` = `12.56` | GPU Speed Of Light Throughput is carrying metric DRAM Throughput.
...
- target hotspot: `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `L2 Cache Throughput` = `29.62` | GPU Speed Of Light Throughput is carrying metric L2 Cache Throughput.
...
- guardrail: `sm__pipe_tensor_cycles_active.avg.pct_of_peak_sustained_active` `non_decreasing` from `48.46` | Tensor activity is part of the active bottleneck picture and should not drop after the next code edit.
...
- guardrail: `smsp__warp_issue_stalled_barrier_per_warp_active.pct` `non_increasing` from `8.84` | barrier stalls are consuming 8.84% of active warp issue slots.
- guardrail: `smsp__warp_issue_stalled_mio_throttle_per_warp_active.pct` `non_increasing` from `4.4` | mio throttle stalls are consuming 4.40% of active warp issue slots.
