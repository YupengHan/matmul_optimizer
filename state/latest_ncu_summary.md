...
- source run id: `20260421_084701_bf16_gemm_v1_b5784f4`
- source run dir: `runs/20260421_084701_bf16_gemm_v1_b5784f4`
- status: `available`
- kernel name: `None`
- block size: `None`
- grid size: `None`
...
- raw csv path: `runs/20260421_084701_bf16_gemm_v1_b5784f4/ncu_metrics.csv`
- raw rep path: `runs/20260421_084701_bf16_gemm_v1_b5784f4/ncu_profile.ncu-rep`
- raw detailed csv path: `runs/20260421_084701_bf16_gemm_v1_b5784f4/ncu_details.csv`
