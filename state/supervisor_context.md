...
- latest run id: `20260421_012143_bf16_gemm_v1_803e749`
- latest runtime: `24.517119 ms`
...
- active loop: `round 29/100` with `72` rounds remaining
- auto-use recommended: `yes`
- auto-select frontier: `no`
- context compression cadence: every `5` completed rounds
- public display refresh cadence: every `5` completed rounds
- last context compression checkpoint: after `25` completed rounds
- next context compression checkpoint: after `30` completed rounds
- last display refresh checkpoint: after `25` completed rounds
- next display refresh checkpoint: after `30` completed rounds
...
- latest observed progress: `2026-04-21T01:21:49-07:00` via `state/graph_state.json`
- idle minutes: `0.0`
- watchdog status: `healthy`
