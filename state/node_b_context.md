        ...
        - `runs/20260421_185050_bf16_gemm_v1_434ded2a/ncu_analysis.md`
        - `runs/20260421_185050_bf16_gemm_v1_434ded2a/ncu_analysis.json`
        - `docs/heuristics.md`
        - `state/progress.md`
        ...
        - `runs/20260421_185050_bf16_gemm_v1_434ded2a/summary.json`
        - `runs/20260421_185050_bf16_gemm_v1_434ded2a/ncu_details_page.csv`
        - `runs/20260421_185050_bf16_gemm_v1_434ded2a/ncu_source.csv`
        - `runs/20260421_185050_bf16_gemm_v1_434ded2a/ncu_import_raw.csv`
        - `runs/20260421_185050_bf16_gemm_v1_434ded2a/ncu_details.csv`
        - `runs/20260421_185050_bf16_gemm_v1_434ded2a/ncu_metrics.csv`
        - `runs/20260421_185050_bf16_gemm_v1_434ded2a/ncu_profile.ncu-rep`
...
- `Stage`: use a multi-buffer algorithm that prefetches global memory into shared memory
        ...
        - rounds remaining after this one: `12`
