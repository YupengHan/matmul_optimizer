...
- schema version: `2`
- source run id: `20260421_133418_bf16_gemm_v1_c859cd06`
- source run dir: `runs/20260421_133418_bf16_gemm_v1_c859cd06`
- status: `available`
- analysis path: `runs/20260421_133418_bf16_gemm_v1_c859cd06/ncu_analysis.json`
- raw csv path: `runs/20260421_133418_bf16_gemm_v1_c859cd06/ncu_metrics.csv`
- raw rep path: `runs/20260421_133418_bf16_gemm_v1_c859cd06/ncu_profile.ncu-rep`
- imported raw csv path: `runs/20260421_133418_bf16_gemm_v1_c859cd06/ncu_import_raw.csv`
- legacy import-raw alias path: `runs/20260421_133418_bf16_gemm_v1_c859cd06/ncu_details.csv`
- details page csv path: `runs/20260421_133418_bf16_gemm_v1_c859cd06/ncu_details_page.csv`
- source page csv path: `runs/20260421_133418_bf16_gemm_v1_c859cd06/ncu_source.csv`
...
- `gpu__compute_memory_throughput.avg.pct_of_peak_sustained_elapsed`: `46.14`
- `dram__throughput.avg.pct_of_peak_sustained_elapsed`: `12.48`
- `lts__throughput.avg.pct_of_peak_sustained_elapsed`: `29.94`
- `sm__warps_active.avg.pct_of_peak_sustained_active`: `16.62`
- `smsp__warp_issue_stalled_barrier_per_warp_active.pct`: `5.49`
- `smsp__warp_issue_stalled_long_scoreboard_per_warp_active.pct`: `7.19`
...
- `long_scoreboard`: `7.19` | long scoreboard stalls are consuming 7.19% of active warp issue slots.
...
- target hotspot: `section` `GPU Speed Of Light Throughput` @ `GPU Speed Of Light Throughput` | `L2 Cache Throughput` = `29.99` | GPU Speed Of Light Throughput is carrying metric L2 Cache Throughput.
...
- guardrail: `smsp__warp_issue_stalled_long_scoreboard_per_warp_active.pct` `non_increasing` from `7.19` | long scoreboard stalls are consuming 7.19% of active warp issue slots.
