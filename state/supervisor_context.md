...
- active loop: `round 33/100` with `68` rounds remaining
...
- latest observed progress: `2026-04-21T01:40:58-07:00` via `state/latest_diagnosis.json`
- idle minutes: `0.0`
- watchdog status: `healthy`
