...
- candidate id: `auto_diagnosis_round_042:dir_01`
- base run id: `20260421_083825_bf16_gemm_v1_97c626c`
...
- source diagnosis id: `auto_diagnosis_round_042`
- round loop: `round 42/100`
- hypothesis: `The latest measured run landed at 24.535552 ms, still +0.371280 ms away from the accepted 24.164272 ms anchor. The fastest way to keep the loop grounded is to replay the exact accepted PTX surface before reopening another branch.`
