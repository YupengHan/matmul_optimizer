...
- latest run id: `20260421_083922_bf16_gemm_v1_cf4c90d`
- latest runtime: `24.440320 ms`
...
- active loop: `round 48/100` with `53` rounds remaining
...
- latest observed progress: `2026-04-21T08:39:28-07:00` via `state/graph_state.json`
- idle minutes: `0.0`
- watchdog status: `healthy`
