...
- notes: `Build passed for round 12/20. Node A will measure the result next.`
...
- verdict: `regressed`
- runtime delta: `+0.385025 ms`
- TFLOP/s delta: `-0.145314 TFLOP/s`
- run dir: `runs/20260419_000651_bf16_gemm_v1_662a03b`
- ncu rep path: `runs/20260419_000651_bf16_gemm_v1_662a03b/ncu_profile.ncu-rep`
