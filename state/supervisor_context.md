...
- active loop: `round 14/100` with `87` rounds remaining
...
- latest observed progress: `2026-04-21T00:03:23-07:00` via `state/graph_state.json`
- idle minutes: `0.0`
- watchdog status: `healthy`
