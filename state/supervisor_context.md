...
- latest run id: `20260421_084752_bf16_gemm_v1_12737de`
- latest runtime: `24.626304 ms`
...
- active loop: `round 89/100` with `12` rounds remaining
...
- latest observed progress: `2026-04-21T08:47:58-07:00` via `state/graph_state.json`
- idle minutes: `0.0`
- watchdog status: `healthy`
