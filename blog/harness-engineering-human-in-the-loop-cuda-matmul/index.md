...
So far, the result is already interesting enough to share: the custom kernel moved from roughly **800 ms** at the beginning to **about 30 ms**, while the local CUTLASS baseline on the same benchmark is **25.9 ms**.
