...
- active loop: `round 35/100` with `66` rounds remaining
...
- latest observed progress: `2026-04-21T07:45:47-07:00` via `state/active_direction.json`
- idle minutes: `0.0`
- watchdog status: `healthy`
