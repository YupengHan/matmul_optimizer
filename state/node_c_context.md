...
- candidate id: `auto_diagnosis_round_086:dir_01`
- base run id: `20260421_084720_bf16_gemm_v1_7e1004b`
...
- source diagnosis id: `auto_diagnosis_round_086`
- round loop: `round 86/100`
- hypothesis: `The latest measured run landed at 24.642097 ms, still +0.477824 ms away from the accepted 24.164272 ms anchor. The fastest way to keep the loop grounded is to replay the exact accepted PTX surface before reopening another branch.`
