...
- candidate id: `auto_diagnosis_round_078:dir_01`
- base run id: `20260421_084602_bf16_gemm_v1_9062401`
...
- source diagnosis id: `auto_diagnosis_round_078`
- round loop: `round 78/100`
- hypothesis: `The latest measured run landed at 24.627200 ms, still +0.462928 ms away from the accepted 24.164272 ms anchor. The fastest way to keep the loop grounded is to replay the exact accepted PTX surface before reopening another branch.`
